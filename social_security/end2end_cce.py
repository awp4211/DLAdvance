...
def cluster_2_vec_test(dataset_df,
                       id_df,
                       model,
                       num_cluster):
...
def train_and_test(training_x, training_y, validation_x, validation_y,
                   test_x, test_ids,
                    num_feature,
                    num_fc,
                    learning_rate,
    ...
    return best_f1, best_epoch, test_pd
...
if __name__ == '__main__':
    ...
    train_feature_vecs, train_feature_labels, mbk_model = cluster_2_vec(train_dataset_df,
                                                                        train_id_df,
                                                                        downsample_ratio=args.down_sample,
                                                                        num_cluster=num_feature,
                                                                        model_name=_make_hparam_string(
                                                                                        learning_rate,
                                                                                        num_fc,
                                                                                        num_feature))
