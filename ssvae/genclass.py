...
class GenerativeClassifier(object):
    def __init__(self,
        ...
        self.distributions = {'p_x': p_x, 'q_z': q_z,
                              'p_z': p_z, 'p_y' :'uniform'}
    ...
    def _objective(self):
        ...
        def L(x_recon, x, y, z):
            ...
            self.y_ulab_logits, self.x_ulab = self._generate_yx(self.x_unlabelled_mu, self.x_unlabelled_lsgms,
                                                                reuse=True)
                ...
                with self.session as sess:
                    ...
                    for epoch in range(epochs):
                        ...
                        for x_l_mu, x_l_lsgms, y, x_u_mu, x_u_lsgms in utils.feed_numpy_semisupervised(
                                ...
                                _data_labelled[:, :2 * self.dim_x], _data_labelled[:, 2 * self.dim_x:],
                                _data_unlabelled):
