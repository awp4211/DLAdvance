...
class stacked_vaegan_celeba(object):
            ...
            while epoch <= self.max_epoch:
                ...
                while batch_num < len(self.ds_train)/self.batch_size:
                    ...
                    if step % 20 == 0:
                        ...
                        print("EPOCH %d step %d: D: loss = %.7f G: loss=%.7f Encode: loss=%.7f LL loss=%.7f KL=%.7f" % (epoch, step, D_loss, fake_loss, encode_loss, LL_loss, kl_loss))

                    if np.mod(step, 200) == 1:
                        save_images(realbatch_array[0:self.batch_size], [int(np.sqrt(self.batch_size)), int(np.sqrt(self.batch_size))],
                        ...
                        save_images(sample_images[0:self.batch_size], [int(np.sqrt(self.batch_size)), int(np.sqrt(self.batch_size))],
